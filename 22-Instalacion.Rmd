...
```{r rproject, echo=FALSE, fig.show = "hold", fig.cap="Web de [R-project](https://r-project.org) y [CRAN](https://cran.r-project.org).", out.width="45%"}
knitr::include_graphics(c("figuras/rproject.png", "figuras/cran.png") )
```
...
```{r rdownload, echo=FALSE, fig.cap="Web de [descarga de R para Windows](http://ftp.cixug.es/CRAN/bin/windows).", out.width="50%"}
knitr::include_graphics("figuras/R351.png")
```
...
```{r asistente, echo=FALSE, fig.cap="Pasos del asistente para instalación de R en Windows.", out.width="90%"}
knitr::include_graphics("figuras/asistente.png")
```
...
```{r permisos-library, echo=FALSE, fig.show = "hold", fig.cap="Pasos en Windows para cambiar permisos en la carpeta library.", out.width="45%"}
knitr::include_graphics(c("figuras/propiedades.png", "figuras/permisos.png") )
```
